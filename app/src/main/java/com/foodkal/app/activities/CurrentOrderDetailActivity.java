...
import static com.foodkal.app.helper.GlobalData.ORDER_STATUS;
import static com.foodkal.app.helper.GlobalData.isSelectedOrder;
...
public class CurrentOrderDetailActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener,
    ...
    private String getUrl(double source_latitude, double source_longitude, double dest_latitude, double dest_longitude) {
        ...
        return "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=AIzaSyBBBo9Qpkyu2xyn8L701KVdcEDsSHP-KlI";
    }

...
public class SaveDeliveryLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    com.foodkal.app.models.Address address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = new com.foodkal.app.models.Address();
...
//            getAddress(context, srcLat, srcLng);
    ...
    private void saveAddress() {
        if (address != null && address.getMapAddress() != null && validate()) {
            ...
            Call<com.foodkal.app.models.Address> call = apiInterface.saveAddress(address);
            call.enqueue(new Callback<com.foodkal.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.foodkal.app.models.Address> call, @NonNull Response<com.foodkal.app.models.Address> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<com.foodkal.app.models.Address> call, @NonNull Throwable t) {
    ...
    private void updateAddress() {
        ...
        if (address != null && address.getId() != null && validate()) {
            customDialog.show();
            apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
            Call<com.foodkal.app.models.Address> call = apiInterface.updateAddress(address.getId(), address);
            call.enqueue(new Callback<com.foodkal.app.models.Address>() {
                @Override
                public void onResponse(@NonNull Call<com.foodkal.app.models.Address> call, @NonNull Response<com.foodkal.app.models.Address> response) {
                    customDialog.dismiss();

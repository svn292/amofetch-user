...
import com.foodkal.app.adapter.AddOnsAdapter;
import com.foodkal.app.adapter.SliderPagerAdapter;
...
import com.foodkal.app.models.Addon;
...
import static com.foodkal.app.adapter.AddOnsAdapter.list;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GlobalData.addCart != null) if (GlobalData.addCart.getProductList().size() != 0)
        ...
        addItemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (GlobalData.profileModel == null)
                    ...
                    if (!Utils.isShopChanged(product.getShopId())) addItem(map);
                    else {
